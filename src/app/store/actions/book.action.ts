...
export enum BookActionTypes {
  ...
  BookRequested = '[Books Home Page] Book Requested',
  BookLoaded = '[Books API] Book Loaded',

  AllBooksRequested = '[Books Home Page] All Books Requested',
  AllBooksLoaded = '[Books API] All Books Loaded'
...
export type BookActions = BookRequested | BookLoaded | AllBooksRequested | AllBooksLoaded;
//     ToggleBookCode
//   | SetCurrentBook
//   | ClearCurrentBook
